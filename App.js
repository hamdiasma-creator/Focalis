...
export function makeStyles(T) {
  return StyleSheet.create({
    ...
    modalTitle:    { fontSize:17, textAlign:"center", marginBottom:8, color:T.text },
    ...
    btnDangerTxt: { fontSize:14, color:"#fff" },
    btnPrimary:   { padding:14, borderRadius:12, alignItems:"center" },
    btnPrimaryTxt:{ fontSize:14, color:"#fff" },
    ...
    moveBtnDay:  { fontSize:14, color:T.text },
    ...
    carryTitle:  { fontSize:14, color:T.text },
    ...
    headerTitle:  { fontSize:18, color:T.text },
    ...
    dayHeaderTag: { fontSize:10, textTransform:"uppercase", letterSpacing:1, marginBottom:1 },
    dayHeaderName:{ fontSize:16, color:T.text },
    dayHeaderDate:{ fontSize:11, color:T.muted, marginTop:1 },
    dayHeaderPct: { fontSize:18 },
    ...
    profileLabel:      { fontSize:15, color:T.text },
