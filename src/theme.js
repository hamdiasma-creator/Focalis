...
export function makeStyles(T) {
  return StyleSheet.create({
    ...
    listsRow:     { flexDirection:"row", gap:8, paddingHorizontal:10, paddingVertical:8, backgroundColor:T.surface, borderBottomWidth:1, borderBottomColor:T.border },
    listBtn:      { flex:1, flexDirection:"row", alignItems:"center", justifyContent:"center", gap:6, paddingVertical:9, borderWidth:1, borderColor:T.border, borderRadius:10, backgroundColor:T.bg },
    listBtnEmoji: { fontSize:15 },
    listBtnTxt:   { fontSize:13, fontFamily:"Lexend_600SemiBold", color:T.text },
    listItemRow:  { flexDirection:"row", alignItems:"center", gap:12, paddingVertical:12, paddingHorizontal:4, borderBottomWidth:1, borderBottomColor:T.border },
    listItemLabel:     { fontSize:15, fontFamily:"Lexend_400Regular", color:T.text, flex:1 },
    listItemLabelDone: { color:T.muted, textDecorationLine:"line-through" },
    listAddRow:   { flexDirection:"row", gap:8, alignItems:"center", paddingVertical:10 },
    listInput:    { flex:1, borderWidth:1, borderColor:T.border, borderRadius:10, padding:11, fontSize:14, fontFamily:"Lexend_400Regular", color:T.text },
    listAddBtn:   { width:44, height:44, borderRadius:10, alignItems:"center", justifyContent:"center" },
